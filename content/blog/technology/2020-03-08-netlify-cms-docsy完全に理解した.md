...
title: Netlify + Netlify CMS + Hugo + DocsyでBlog構築
---
...
本Blogを構築するにあたり必要な設定は全て[サイトのGitHubレポジトリ](https://github.com/sharplab/sharplab.net)に収まっているので、そちらを参照して頂ければ全て追うことが出来ると思いますが、今回は自分が躓いたポイントを中心に導入方法を記載したいと思います。
